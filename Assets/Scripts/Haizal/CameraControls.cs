...
public class CameraControls : MonoBehaviour
{
    ...
    [SerializeField, Range(0.1f, 10f)] float distance = 3f;
    ...
    private void LateUpdate()
    {
        ...
        if (OrbitCamera() && !IsPointerOverUIElement())
        {
    ...
    static List<RaycastResult> GetEventSystemRaycastResults()
    {
        ...
        eventData.position = Touchscreen.current.primaryTouch.position.value;
